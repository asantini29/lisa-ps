...
This package is designed to interact with the `eryn` MCMC sampler (https://github.com/mikekatz04/Eryn). The paper describing the code implementation can be found on ArXiv: TODO
